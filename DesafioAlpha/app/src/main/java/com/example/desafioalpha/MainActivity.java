...
//                        Log.v(TAG_LOG, log_dados_recebidos);
                    ...
                    for (Integer grupo=0; grupo <= tamanhoLista; grupo++) {
                        ...
                        if (isSeparator == false) {
                            ...
                            for (int am1=0;am1<=2; am1++) {
                                amenidadeNameOrd[am1] = "";
                                amenidadeCategoriaOrd[am1] = "";
                            }

                            hotelsListaOrdenada.add(new Hotels(nome, preco  , cidade, state,
                                    amenidadeNameOrd,
                                    amenidadeCategoriaOrd, stars, foto, isSeparator));
                    ...
                    HotelAdapter mAdapter = new HotelAdapter(getApplicationContext(),hotelsListaOrdenada);
