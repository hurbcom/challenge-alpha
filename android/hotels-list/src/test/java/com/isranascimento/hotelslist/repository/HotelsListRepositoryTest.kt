...
class HotelsListRepositoryTest {
    ...
    private class HotelsDataSourceDouble(
        ...
        override suspend fun getHotelsList(): NetworkResponse<HotelsResponse> = when(expectedResponseStatus) {
            SUCCESS -> NetworkResponse.Success(Response.success(expectedResponse()))
