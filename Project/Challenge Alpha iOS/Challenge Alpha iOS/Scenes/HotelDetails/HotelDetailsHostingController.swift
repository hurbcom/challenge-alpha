//
//  HotelDetailsHostingController.swift
//  Challenge Alpha iOS
//
...
final class HotelDetailsHostingController: UIHostingController<HotelDetailsView> {
    
    let viewModel: HotelDetailsViewModel
    
    init(viewModel: HotelDetailsViewModel, rootView: HotelDetailsView) {
