...
struct FileStructure {
    ...
    init() throws {
        ...
        self.sourceRootURL = parentFolderOfScriptFile.apollo.parentFolderURL()
        
        self.huGraphQLRootURL = parentFolderOfScriptFile
          .apollo.parentFolderURL() // Result: Sources folder
          .apollo.childFolderURL(folderName: "HUGraphQL") // Result: HUGraphQL folder
